...
SECRET_KEY = "django-insecure-&e_^6c1ks8r!d^m&q2gs-6!l=pc)7m+(_h&bgi60y1v_5518+h"
...
AWS_S3_REGION_NAME = os.getenv("MINIO_REGION_NAME")
AWS_S3_USE_SSL = os.getenv("MINIO_USE_SSL")
