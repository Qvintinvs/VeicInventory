...
from views.vasques_emission_round_api import VasquesEmissionRoundAPI
...
def create_vasques_emission_round_api_blueprint(
    ...
    round_api = VasquesEmissionRoundAPI(vasques_emission_round_repository)
    ...
    api_blueprint.add_url_rule(
        "/get_round", view_func=round_api.list_most_urgent_round, methods=["GET"]
    )
