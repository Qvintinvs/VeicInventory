...
def register_app_routes(app: Flask):
    ...
    wrf_inventory_blueprint = (
        wrf_standard_emission_routes.create_wrf_standard_emission_blueprint()
    )
    ...
    app.register_blueprint(wrf_inventory_blueprint)
